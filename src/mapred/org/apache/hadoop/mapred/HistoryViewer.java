...
class HistoryViewer {
  ...
  throws ParseException {
    ...
    Counters totalCounters = Counters.fromEscapedCompactString(job.get(Keys.COUNTERS));
  ...
  private void printAnalysis(JobHistory.Task [] tasks, Comparator<JobHistory.Task> cmp,
