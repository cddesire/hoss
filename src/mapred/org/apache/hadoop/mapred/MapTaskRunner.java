...
class MapTaskRunner extends TaskRunner {
  ...
  public String getChildJavaOpts(JobConf jobConf, String defaultValue) {
    String user = jobConf.get(JobConf.MAPRED_MAP_TASK_JAVA_OPTS,
                  super.getChildJavaOpts(jobConf, JobConf.DEFAULT_MAPRED_TASK_JAVA_OPTS));
    String admin = jobConf.get(TaskRunner.MAPRED_MAP_ADMIN_JAVA_OPTS,
  ...
  public int getChildUlimit(JobConf jobConf) {
    return jobConf.getInt(JobConf.MAPRED_MAP_TASK_ULIMIT, super.getChildUlimit(jobConf));
  }
