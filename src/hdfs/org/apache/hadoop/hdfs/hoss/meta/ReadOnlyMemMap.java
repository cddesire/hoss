...
import org.apache.hadoop.hdfs.hoss.meta.ByteBufferCleaner;
import org.apache.hadoop.hdfs.hoss.meta.CorruptedIndexException;
import org.apache.hadoop.hdfs.hoss.meta.HosReaderClosedException;
...
final class ReadOnlyMemMap implements RandomAccessData {
  ...
  private MappedByteBuffer[] getChunks() throws HosReaderClosedException {
  ...
  private MappedByteBuffer getCurChunk() throws HosReaderClosedException {
  ...
  private HosReaderClosedException closedException() {
    return new HosReaderClosedException("Reader has been closed");
  }
