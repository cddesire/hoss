public class IPUtils  {
    ...
    public static String ipInt2DotDec(int ipInt)
            throws IllegalArgumentException {
        return ipLong2DotDec(((long) ipInt) & 0xFFFFFFFFL);
    }

    public static String ipLong2DotDec(long ipLong)
            throws IllegalArgumentException {
        if (ipLong < 0) {
            throw new IllegalArgumentException("argument must be positive");
        } else if (ipLong > 4294967295L) {
            throw new IllegalArgumentException(
                    "argument must be smaller than 4294967295L");
        }
    ...
    public static long ipDotDec2Long(String ipDotDec)
            throws IllegalArgumentException {
    ...
    public static String ipHex2DotDec(String ipHex)
            throws IllegalArgumentException {
        if (ipHex == null) {
            throw new IllegalArgumentException("argument is null");
        }
    ...
    public static String ipDotDec2Hex(String ipDotDec)
            throws IllegalArgumentException {
    ...
    public String long2IP(Long ipLong) throws IllegalArgumentException {
        if (ipLong == null || ipLong < 0 || ipLong > 4294967295L) {
            return null;
        }
    ...
    public Long ip2Long(String ip, Boolean ignoreError) throws Exception {
        if (ip == null || ip.length() == 0) {
            return null;
        }

        try {
            return IpUtils.ipDotDec2Long(ip);
        } catch (Exception ex) {
            System.err.println("illegal ip : " + ip);
